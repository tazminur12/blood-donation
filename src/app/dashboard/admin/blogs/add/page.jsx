...
export default function AddBlog() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const blogData = {
        ...
        status: "published", // Direct publish by default
        createdAt: new Date().toISOString(),
        author: formData.author.trim() || session?.user?.name || "Admin",
      ...
      if (res.ok) {
        Swal.fire({
          icon: "success",
          title: "সফল!",
          text: "ব্লগ সফলভাবে প্রকাশিত হয়েছে",
          confirmButtonText: "ঠিক আছে",
          confirmButtonColor: "#10b981",
          timer: 2000,
          timerProgressBar: true,
        ...
        Swal.fire({
          icon: "error",
          title: "ত্রুটি",
          text: data.error || data.message || "ব্লগ তৈরি করতে ব্যর্থ হয়েছে",
          confirmButtonText: "ঠিক আছে",
          confirmButtonColor: "#ef4444",
        });
      }
      ...
      Swal.fire({
        icon: "error",
        title: "ত্রুটি",
        text: "ব্লগ তৈরি করতে ব্যর্থ হয়েছে: " + err.message,
        confirmButtonText: "ঠিক আছে",
        confirmButtonColor: "#ef4444",
      });
    } finally {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-sm border border-slate-200">
      <PageTitle title="নতুন ব্লগ তৈরি করুন" />
