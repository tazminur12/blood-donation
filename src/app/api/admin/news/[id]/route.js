...
export async function GET(request, { params }) {
  try {
    ...
    const formattedNews = {
      ...
      newspaperName: news.newspaperName || "",
...
export async function PUT(request, { params }) {
  try {
    ...
    if (newspaperName !== undefined) updateData.newspaperName = newspaperName;
    ...
    const formattedNews = {
      ...
      newspaperName: updatedNews.newspaperName || "",
      publicationDate: updatedNews.publicationDate || null,
