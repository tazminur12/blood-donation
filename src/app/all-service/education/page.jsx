...
export default function EducationPage() {
  ...
  }, [institutes, searchTerm, selectedType, selectedLevel]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg font-medium">
            শিক্ষা প্রতিষ্ঠানের তথ্য লোড হচ্ছে...
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-opacity-20 rounded-full mb-3">
              <FiBookOpen className="w-6 h-6" />
            </div>
            <h1 className="text-2xl md:text-3xl font-bold mb-2">
              গোবিন্দগঞ্জের শিক্ষা প্রতিষ্ঠান
            </h1>
            <p className="text-base text-blue-100 max-w-3xl mx-auto">
              গোবিন্দগঞ্জের সকল শিক্ষা প্রতিষ্ঠানের বিস্তারিত তথ্য। আপনার সন্তানের
              ভবিষ্যৎ গড়ার জন্য সঠিক প্রতিষ্ঠান নির্বাচন করুন।
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900">
              {institutes.filter((i) => i.type === "school").length}
            </h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900">
              {institutes.filter((i) => i.type === "college").length}
            </h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900">
              {institutes.filter((i) => i.type === "school_and_college").length}
            </h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900">
              {institutes.filter((i) => i.type === "university").length}
            </h3>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900">
              {institutes.filter((i) => i.type === "madrasa").length}
            </h3>
        ...
        <div className="flex justify-between items-center mb-6">
          <p className="text-gray-600">
            <span className="font-semibold">{filteredInstitutes.length}</span>টি
            প্রতিষ্ঠান পাওয়া গেছে
          </p>
        </div>
            ...
            {filteredInstitutes.map((institute) => (
              ...
              >
                ...
                <div className="relative h-48 bg-gradient-to-br from-blue-400 to-indigo-500">
                  ...
                  <button
                    onClick={() => toggleFavorite(institute.id)}
                    className={`absolute top-3 right-3 p-2 rounded-full transition-colors ${
                      favorites.includes(institute.id)
