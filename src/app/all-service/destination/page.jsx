...
export default function DestinationPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 py-8">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">
            গোবিন্দগঞ্জের অপরূপ গন্তব্যসমূহ
          </h1>
          <p className="text-sm md:text-base text-blue-100 max-w-3xl mx-auto">
            ঐতিহাসিক স্থান থেকে প্রাকৃতিক সৌন্দর্য, গোবিন্দগঞ্জের প্রতিটি গন্তব্য
            আপনাকে মুগ্ধ করবে
          </p>
        </div>
      </div>
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4 line-clamp-3 leading-relaxed">
                    {destination.description ||
                      "এই গন্তব্যটি সম্পর্কে বিস্তারিত তথ্য পাওয়া যায়নি।"}
                  </p>
                    ...
                    {destination.stayInfo && (
                      <div className="flex items-center text-sm text-gray-500">
                        ...
                        <span className="line-clamp-1">
                          থাকার ব্যবস্থা: {destination.stayInfo}
                        </span>
                      </div>
                    )}
                    {destination.travelInfo && (
                      <div className="flex items-center text-sm text-gray-500">
                        <FaRoute className="w-4 h-4 mr-2 text-green-600" />
                        <span className="line-clamp-1">
                          যাওয়ার উপায়: {destination.travelInfo}
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Link
                      href={`/all-service/destination/${destination.id}`}
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">
              গোবিন্দগঞ্জের সেরা গন্তব্যসমূহ
            </h3>
            <p className="text-gray-600 max-w-2xl mx-auto">
              ঐতিহাসিক স্থান থেকে শুরু করে প্রাকৃতিক সৌন্দর্যে ভরপুর বিভিন্ন স্থান,
              গোবিন্দগঞ্জ আপনাকে নিয়ে যাবে এক অপরূপ ভ্রমণ অভিজ্ঞতায়।
            </p>
          </div>
        </div>
      </div>
